      ...
      >
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center group">
            ...
            <h1 className="text-white font-semibold text-xl group-hover:text-primary transition-colors duration-300">ChatApp</h1>
          </Link>
        </div>
        
        <div className="flex items-center space-x-4">
          <Link href="/groups" className="text-gray-300 hover:text-primary relative rounded-full p-2 hover:bg-dark-light transition-all duration-300">
          ...
          <Link href="/settings" className="text-gray-300 hover:text-primary rounded-full p-2 hover:bg-dark-light transition-all duration-300">
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/profile" className="flex items-center group">
            <div className="relative">
              <motion.div
                ...
                className="w-10 h-10 rounded-full border-2 border-transparent group-hover:border-primary overflow-hidden transition-all duration-300 cursor-pointer"
              >
                <img
                  src={session?.user?.avatar || "https://ui-avatars.com/api/?name=" + encodeURIComponent(session?.user?.name || "User") + "&background=25D366&color=fff"}

        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-dark-lighter rounded-xl p-6 border border-gray-800 hover:border-primary/50 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mt-1">{stats.messages}</h3>
              </div>
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-4 mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <Link href="/chat" className="bg-dark-lighter hover:bg-dark-light rounded-xl p-4 border border-gray-800 flex flex-col items-center justify-center text-center transition-colors">
              ...
              <Link href="/groups/new" className="bg-dark-lighter hover:bg-dark-light rounded-xl p-4 border border-gray-800 flex flex-col items-center justify-center text-center transition-colors">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-4 mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link href="/chat" className="text-primary hover:text-primary-light text-sm font-medium transition-colors">
                View All
              </Link>
            </div>
              ...
              {recentChats.map((chat, index) => (
                <Link 
                  ...
                  className={`flex items-center p-4 hover:bg-dark-light transition-colors ${
                    index !== recentChats.length - 1 ? 'border-b border-gray-800' : ''
                  }`}
                >
                  ...
                  {chat.unread > 0 && (
                    <div className="ml-3 bg-primary rounded-full w-5 h-5 flex items-center justify-center">
                      <span className="text-dark text-xs font-bold">{chat.unread}</span>
                    </div>
                  )}
                </Link>
              ))}
